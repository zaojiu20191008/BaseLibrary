package com.niubility.library.widget.dialog.wechat;
...
public class WxLoadingDialog extends Dialog {
    ...
    private static class MHandler extends Handler {
        private final WeakReference<WxLoadingDialog> mDialog;

        public MHandler(WxLoadingDialog mDialog) {
        ...
        public void handleMessage(Message msg) {
            ...
            WxLoadingDialog dialog = mDialog.get();
