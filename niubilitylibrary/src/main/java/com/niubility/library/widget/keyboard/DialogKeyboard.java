...
public class DialogKeyboard extends KeyboardView {
    ...
    public DialogKeyboard(Context context, AttributeSet attrs) {
        ...
        keyboardXml = new Keyboard(context, R.xml.layout_dialog_keyboard_numeric);
    ...
    public DialogKeyboard(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        editText.setKeyListener(null);
    ...
    private void drawSureText(Canvas canvas, Keyboard.Key key) {
        ...
        canvas.drawText(showStrFirst, key.x + (key.width / 2) + 16,
                (key.y + key.height / 2) + bounds.height() / 2 + 16 - 25, paint);
